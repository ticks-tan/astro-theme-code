...
<div align="center">
  <p align="center">
    ...
    <p>
      A minimalist blog theme based on <a href="https://github.com/kirontoo/astro-theme-cody/tree/v1.3.1">astro-theme-cody v1.3.1</a>.
    </p>
  </p>
</div>
...
6. [Deploy](#deploy)
7. [Extra Functionality](#extra-funtionality)
8. [Credit](#credit)
...
Check out the demo (will depoly it soon).
...
```bash
git clone https://github.com/ticks-tan/astro-theme-code.git
# new branch
git checkout -b depoly
# do something and commit
git remote add depoly <remote_url>
git push -u depoly depoly:<remote_branch>
```
...
| katex                    | Optional boolran. Enable the katex render if this blog use katex.                                                                                        |
